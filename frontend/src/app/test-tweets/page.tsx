...
export default function TestTweets() {
  ...
  const distributeMessages = () => {
    ...
    let messageIndex = 0;
    const tweetId = mode === 'reply' ? extractTweetId(tweetUrl) || undefined : undefined;
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-6">
        <h1 className="text-2xl font-bold mb-2">Distribuidor de Tweets (Beta)</h1>
      ...
      <div className="mb-6">
        ...
        <textarea
          ...
          placeholder={`Escribe cada ${mode === 'tweet' ? 'tweet' : 'comentario'} en una línea diferente...`}
        />
      </div>
      ...
      <div className="flex gap-4 mb-6">
        ...
        {distribution.length > 0 && (
          ...
          >
            {loading ? 'Publicando...' : `Publicar ${mode === 'tweet' ? 'Tweets' : 'Comentarios'}`}
          </button>
        )}
      </div>
      ...
      {distribution.length > 0 && (
        <div className="border rounded-lg p-4 dark:border-gray-700">
          <h2 className="text-lg font-semibold mb-4">Vista Previa de Distribución</h2>
